...
TESTHEXCORRUPT_FILENAME = "corruption.hex"
TESTHEXCORRUPT_PATH = os.path.join(TESTFILES_DIR, TESTHEXCORRUPT_FILENAME)

TESTHEXFX_FILENAME = "mmfx.hex"
TESTHEXFX_PATH = os.path.join(TESTFILES_DIR, TESTHEXFX_FILENAME)

TESTHEXFX2_FILENAME = "poafx.hex"
TESTHEXFX2_PATH = os.path.join(TESTFILES_DIR, TESTHEXFX2_FILENAME)
